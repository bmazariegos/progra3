...
public class MenuArboles extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Eti_titulo1.setText("Arboles binarios");
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 390, 580));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void btn_codigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_codigoActionPerformed
        abrirarchivo("arbol/Vistaa.java");
        abrirarchivo("arbol/Arbol.java");
        abrirarchivo("arbol/SimuladorArbolBinario.java");
    ...
    private void btn_youtubeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_youtubeActionPerformed
        try{
            Desktop.getDesktop().browse(new URI("https://www.youtube.com/watch?v=D4NxObLZ6mA&t=13s"));
        }catch(Exception e)
        {
    ...
    private void btn_githubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_githubActionPerformed
        try{
            Desktop.getDesktop().browse(new URI("https://github.com/bmazariegos/progra3/tree/master/ArbolBusqueda"));
        }catch(Exception e)
        {
            JOptionPane.showMessageDialog(null,"No se pudo conestar"+e);
        }
    ...
    private void btn_SalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SalirActionPerformed
        ...
        if (codigo==JOptionPane.YES_OPTION){
          ...
          MenuArboles ventana = new MenuArboles();
        ventana.show();
        dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuArboles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuArboles().setVisible(true);
            }
        });
    }

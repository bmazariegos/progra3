...
public class MenuPilas extends javax.swing.JFrame {
    ...
    private void btn_youtubeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_youtubeActionPerformed
        try{
            Desktop.getDesktop().browse(new URI("https://www.youtube.com/watch?v=pXrlWrbgTaw"));
        }catch(Exception e)
        {
    ...
    private void btn_githubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_githubActionPerformed
        try{
            Desktop.getDesktop().browse(new URI("https://github.com/bmazariegos/progra3/tree/master/Pilas"));
        }catch(Exception e)
        {
            JOptionPane.showMessageDialog(null,"No se pudo conestar"+e);
        }
    ...
    private void btn_SalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SalirActionPerformed
        ...
        if (codigo==JOptionPane.YES_OPTION){
          ...
          MenuPilas ventana = new MenuPilas();
        ventana.show();
        dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPilas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

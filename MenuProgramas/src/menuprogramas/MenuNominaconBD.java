...
public class MenuNominaconBD extends javax.swing.JFrame {

    /**
     * Creates new form Menu_Secundario
     */
    public MenuNominaconBD() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Eti_titulo1.setText("    Nomina con BD  ");
        getContentPane().add(Eti_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 330, 100));
    ...
    private void btn_codigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_codigoActionPerformed
        abrirarchivo("nominaBD/lab3/Lab3.java");
        abrirarchivo("nominaBD/modelo/Conexion.java");
        abrirarchivo("nominaBD/modelo/SqlUsuarios.java");
    ...
    private void btn_youtubeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_youtubeActionPerformed
        try{
            Desktop.getDesktop().browse(new URI("https://www.youtube.com/watch?v=ptEnqWTocD4"));
        }catch(Exception e)
        {
    ...
    private void btn_githubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_githubActionPerformed
        try{
            Desktop.getDesktop().browse(new URI("https://github.com/bmazariegos/progra3/tree/master/Nomina%20final%20con%20usuario%20y%20BD"));
        }catch(Exception e)
        {
            JOptionPane.showMessageDialog(null,"No se pudo conestar"+e);
        }
    ...
    private void btn_SalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SalirActionPerformed
        ...
        if (codigo==JOptionPane.YES_OPTION){
          ...
          MenuNominaconBD ventana = new MenuNominaconBD();
        ventana.show();
        dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuNominaconBD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuNominaconBD().setVisible(true);
            }
        });
    }

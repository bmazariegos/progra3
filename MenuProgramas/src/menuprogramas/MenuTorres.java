...
public class MenuTorres extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Eti_titulo1.setText("Torres de Hanoi");
    ...
    private void btn_codigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_codigoActionPerformed
        abrirarchivo("hanoi/Torre.java");
        abrirarchivo("hanoi/Hanoi.java");
    ...
    private void btn_githubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_githubActionPerformed
        try{
            Desktop.getDesktop().browse(new URI("https://github.com/bmazariegos/progra3/tree/master/Torres%20de%20Hanoi"));
        }catch(Exception e)
        {
            JOptionPane.showMessageDialog(null,"No se pudo conestar"+e);
        }
    ...
    private void btn_SalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SalirActionPerformed
        ...
        if (codigo==JOptionPane.YES_OPTION){
          ...
          MenuTorres ventana = new MenuTorres();
        ventana.show();
        dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuTorres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuTorres().setVisible(true);
            }
        });
    }
